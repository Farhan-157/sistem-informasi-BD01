...
<div class="container-custom">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Data Anggota</h1>
            <p class="text-sm text-slate-500 mt-1">Daftar data anggota yang terdaftar.</p>
        </div>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-slate-100 border-b border-slate-200">
                    ...
                    <th class="py-4 px-6 text-sm font-semibold text-slate-700 uppercase tracking-wider">Email</th>
                    <th class="py-4 px-6 text-sm font-semibold text-slate-700 uppercase tracking-wider">No HP</th>
                    <th class="py-4 px-6 text-sm font-semibold text-slate-700 uppercase tracking-wider">Jabatan</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-slate-200 text-slate-600">
                ...
                <tr class="hover:bg-slate-50 transition duration-150">
                    ...
                    <td class="py-4 px-6 font-medium text-slate-900"><?= $data['nama']; ?></td>
                    <td class="py-4 px-6"><?= $data['email']; ?></td>
                    <td class="py-4 px-6"><?= $data['no_hp']; ?></td>
                    <td class="py-4 px-6">
